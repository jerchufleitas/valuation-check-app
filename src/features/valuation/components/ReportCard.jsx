...
const ReportCard = ({ baseValue, adjustments, currency, incoterm, productDesc, reference, onReset }) => {
    ...
    <div className="report-card fade-in">
      ...
      <div className="report-summary">
        <div className="summary-item">
          <span className="label">Valor de Transacción (Base)</span>
        ...
        <div className="summary-total">
          <span className="label">Valor en Aduana Final</span>
      ...
      <div className="report-analysis">
        ...
        {hasAdjustments ? (
          <div className="analysis-box warning">
            ...
            <p>
              <strong>Se REQUIERE Ajuste de Valor.</strong><br/>
              La operación declara elementos que, según el Acuerdo del GATT (Art. 1 y 8), 
              deben ser {totalAdditions > 0 ? "ADICIONADOS" : ""} {totalAdditions > 0 && totalDeductions > 0 ? "y" : ""} {totalDeductions > 0 ? "DEDUCIDOS" : ""} 
               del precio pagado para determinar la base imponible correcta.
            </p>
          </div>
        ) : (
      ...
      <div className="report-actions">
        <button className="btn-secondary" onClick={onReset}>Nueva Consulta</button>
        <button className="btn-primary" onClick={() => generateValuationPDF({ baseValue, adjustments, currency, incoterm, productDesc, reference }, reportFormat)}>
